...
public class CoroutineDumpTestGenerated extends AbstractCoroutineDumpTest {
    ...
    @TestMetadata("testApp1.kt")
    public void testTestApp1() throws Exception {
        runTest("idea/testData/debugger/tinyApp/src/coroutines/testApp1.kt");
    }

    @TestMetadata("testApp2.kt")
    public void testTestApp2() throws Exception {
        runTest("idea/testData/debugger/tinyApp/src/coroutines/testApp2.kt");
    }
}
